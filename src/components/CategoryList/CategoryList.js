...
function Category() {
    const category = [{
        ...
        return (
            <Container className="text-center mt-5 mainContainer" >
                <h1 className="themeColor">Shop by Category</h1>
                <Grid container columns={{ xs: 4, sm: 8, md: 12 }} className="grid" height={300}>
                    <ImageList sx={{ width: 1000, height: 850, mt: 6}} cols={4} rowHeight={250} gap={25}>
                                ...
                                <a href={`/products/${category.name}`}>
                                    <ImageListItem key={category.name}>
                                        <img
                                            ...
                                            loading="lazy"
                                        />
                                    <ImageListItemBar title={category.name} subtitle={category.description} />
                                    </ImageListItem>
                                </a>
